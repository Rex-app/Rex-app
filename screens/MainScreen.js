...
const MainScreen = ({ navigation }) => {
  ...
  */
  ...
  const logData = () => {
    if (googleResponse) {
      if (
        typeof googleResponse.responses[0] === "object" &&
        Array.isArray(googleResponse.responses) &&
        Object.keys(googleResponse.responses[0])[0] === undefined
      ) {
  ...
  const _maybeRenderImage = () => {
    ...
    return (
      ...
      >
        ...
        />
        <LongButton submit={true} onPress={() => submitToGoogleVision()}>
          <Image
        ...
        <View>
          ...
          <View>
            <LongButton
              onPress={() =>
                speak(
                  "Press the blue camera button to take a photo. Press the purple play button to replay the information from the bottle."
                )
              }
            >
              <Image
